<script>
    import { emitProductCompetes } from "../events";
    ...
    // console.log(`meli_id: ${item_data.id}, is_ours: ${is_ours}, is_competitor: ${is_competitor}`);
    ...
    <div class="ti-attributes">
        <div class="ti-attribute ti-name">
            ...
            <span class="ti-attribute-value">
                {#if is_ours}
                    <span class="ti-our-item">(tuyo)</span>
                {:else if is_competitor}
                    <span class="ti-competitor-item">(competidor)</span>
                {/if}
                {item_data.name}
            </span>
        </div>
        ...
        <div class="ti-attribute">
            <span class="ti-attribute-label">Posicion</span>
            <span class="ti-attribute-value">{position}</span>
        </div>
        <div class="ti-attribute">
...
<style>
    ...
    .tic-trend-item:has(.ti-our-item) {
    ...
    .tic-trend-item:has(.ti-our-item) .ti-attribute-value {
